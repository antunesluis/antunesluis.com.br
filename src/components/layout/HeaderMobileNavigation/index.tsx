...
export function HeaderMobileNavigation() {
  ...
  return (
    <div className='md:hidden'>
      ...
      {isOpen && (
        <div
          className='fixed inset-0 z-40 backdrop-blur-sm bg-white/30 dark:bg-black/30 transition-all duration-300'
          onClick={closeMenu}
          aria-hidden='true'
        />
      )}
      ...
      <div
        className={clsx(
          'fixed top-0 right-0 z-50 w-64 h-full bg-white dark:bg-slate-900 shadow-xl transform transition-transform duration-300 ease-in-out',
      ...
      >
        <div className='flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-700'>
          ...
          >
            <X className='w-8 h-8 text-slate-700 dark:text-slate-300' />
          </button>
        </div>
              ...
              <Link
                ...
                className={clsx(
                  ...
                  isActive
                    ...
                    : 'text-slate-700 hover:text-blue-500 hover:bg-slate-50 dark:text-slate-300 dark:hover:text-blue-400 dark:hover:bg-slate-800/50',
                )}
                onClick={closeMenu}
              >
                {link.label}
