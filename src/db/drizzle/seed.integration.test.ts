...
const projectsSeedPath = join(repositoryRoot, 'src/db/seed/projects.json');
...
function createWorkspace() {
  ...
  mkdirSync(join(workspace, 'src/db/seed'), { recursive: true });
  cpSync(projectsSeedPath, join(workspace, 'src/db/seed/projects.json'));
  writeFileSync(
